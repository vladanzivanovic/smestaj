 ...
 */
final class Version20210612145719 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE Image Image VARCHAR(250) DEFAULT NULL, CHANGE SysCreatedUserId SysCreatedUserId INT DEFAULT NULL, CHANGE SysModifyUserId SysModifyUserId INT DEFAULT NULL, CHANGE ParentId ParentId INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE tag CHANGE tag_type_id tag_type_id INT DEFAULT NULL, CHANGE slug slug VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('UPDATE users SET Status = 3 WHERE Status = 2');
        $this->addSql('UPDATE users SET Status = 2 WHERE Status = 1');
        $this->addSql('UPDATE users SET Status = 1 WHERE Status = 0');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ads_payed_date CHANGE ads ads INT DEFAULT NULL');
        $this->addSql('ALTER TABLE adsadditionalinfo CHANGE CapacityMin CapacityMin INT DEFAULT NULL, CHANGE CapacityMax CapacityMax INT DEFAULT NULL, CHANGE AdsId AdsId INT DEFAULT NULL');
        $this->addSql('ALTER TABLE category CHANGE Image Image VARCHAR(250) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE SysCreatedUserId SysCreatedUserId INT DEFAULT NULL, CHANGE SysModifyUserId SysModifyUserId INT DEFAULT NULL, CHANGE ParentId ParentId INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE stars CHANGE ReviewId ReviewId INT DEFAULT NULL');
        $this->addSql('ALTER TABLE tag CHANGE tag_type_id tag_type_id INT DEFAULT NULL, CHANGE slug slug VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
