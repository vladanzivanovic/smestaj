...
final class AdsInsertRequestTest extends TestCase
{
    ...
    {
        $dto = new AdsInsertRequest(new ParameterBag(['title_rs' => 'value']), 'tok');
    ...
    {
        $dto = new AdsInsertRequest(new ParameterBag(), '');
    ...
    {
        $dto = new AdsInsertRequest(new ParameterBag(), 'abc');
